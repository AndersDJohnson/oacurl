 ...
 */
public class Oauth1IntegrationTest {
  ...
  @Test
  public void testLoginV1ExplicitScopeFetchStuff() throws Exception {
  ...
  public void testFetchNotFound() throws Exception {
    ...
    Fetch.main(new String[]{
            "-i",
            "--access-file", oauthTokensFile.getAbsolutePath(),
            "https://www.googleapis.com/buzz/v1/activities/seafsdfsfdsfsdrch"
    });

    // Make sure it contains a few random keywords
    standardOutputCapture.assertContains("HTTP/1.1 404");
  }
}
